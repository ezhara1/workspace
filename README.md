...
- `--jinja --reasoning-budget 0` are llama.cpp server flags and may not exist in all `llama_cpp.server` Python builds; `run_manual.py` auto-detects support and skips unsupported flags.
